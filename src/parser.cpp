...
std::string Parser::GenerateGPPLibraryParameters (std::string file)
{
	pstring current;
	
	std::string fileContents = LoadFile (file);
	std::vector<std::string> lines = Parser::SeperateLines (&fileContents);
...
std::string Parser::LoadFile (std::string fileLocation)
{
